...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'companies-out', title: "Empresas dshabilitadas", component: CompaniesOutComponent, data: { rol: ['ROL_USER','ROL_ADMIN', 'ROL_SUPERADMIN'] } },
      ...
      { path: 'ticket-support', title: "Tickect soporte", component: TicketSupportComponent, data: { rol: ['ROL_USER', 'ROL_ADMIN', 'ROL_SUPERADMIN'] } },
