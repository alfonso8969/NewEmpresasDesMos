...
export class Empresa extends Descripcion {
  ...
  public installation_year: number;
  public workers_number: number;
  ...
  public getInstallation_year(): number {
    return this.installation_year;
  }

  public setInstallation_year(installation_year: number): void {
    this.installation_year = installation_year;
  }

  public getWorkers_number(): number {
    return this.workers_number;
  }

  public setWorkers_number(workers_number: number): void {
